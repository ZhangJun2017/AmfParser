...
public class ErrorMessage extends AcknowledgeMessage {
    ...
    public ErrorMessage(com.weedong.flex.messaging.messages.Message request, Throwable t) {
        super(request);
    ...
    public ErrorMessage copy(com.weedong.flex.messaging.messages.Message request) {
