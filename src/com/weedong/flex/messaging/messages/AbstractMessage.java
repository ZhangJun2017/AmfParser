 ...
 * @author Franck WOLFF
 */
public abstract class AbstractMessage implements com.weedong.flex.messaging.messages.Message {
    ...
    public AbstractMessage(com.weedong.flex.messaging.messages.Message request) {
        super();
