...
public class ActionContext implements Serializable {
    ...
    /**
     * @exclude Performance metrics related field, incoming MPI object, will only be populated when one of
     * the record-message-* params is enabled
     */
    private MessagePerformanceInfo mpii;

    /**
     * @exclude Performance metrics related field, outgoing MPI object, will only be populated when one of
     * the record-message-* params is enabled
     */
